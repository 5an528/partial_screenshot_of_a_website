...
element = browser.find_element(By.XPATH, "/html/body/div[1]/div[2]/div[1]/div/div/div/div[1]/div/img") # find part of the page you want image of
...
im.save('facebook.png') # saves new cropped image